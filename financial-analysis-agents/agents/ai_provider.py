...
class AIProvider:
    ...
    FALLBACK_ORDER = ["gemini-3-pro-preview", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.0-flash-lite", "gemini-1.5-flash", "gemini-1.5-flash-8b", "gemini-1.5-pro"]
    ...
    def __init__(self, api_key: Optional[str] = None, provider_type: str = "gemini", model_name: Optional[str] = None):
        ...
        if self.provider_type == "gemini":
            if not self.api_key:
                raise ValueError("API Key mancante per Gemini.")
